...
export const API_BASE: string | undefined = import.meta.env.VITE_VUE_APP_GATEWAY_URL ? import.meta.env.VITE_VUE_APP_GATEWAY_URL : import.meta.env.VITE_VUE_APP_API_URL;
