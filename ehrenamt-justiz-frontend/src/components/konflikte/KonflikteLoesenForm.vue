  ...
  >
    ...
    >
      <v-expansion-panel
        :title="
          t(
            'components.konflikteLoesenForm.expansionPanel.datenAusEWOUebernehmen'
          )
        "
      >
          ...
          <v-row>
            ...
            >
              <v-text-field
                ...
                density="compact"
                :label="
                  t('components.konflikteLoesenForm.form.ordnungsmerkmal')
                "
                persistent-placeholder
                variant="outlined"
                :hide-details="true"
          ...
          <v-row>
            ...
            >
              <v-text-field
                ...
                density="compact"
                :label="
                  t('components.konflikteLoesenForm.form.akademischerGrad')
                "
                persistent-placeholder
                variant="outlined"
                :hide-details="true"
          ...
          <v-row>
            ...
            >
              <v-text-field
                ...
                density="compact"
                :label="
                  t('components.konflikteLoesenForm.form.appartmentNummer')
                "
                persistent-placeholder
                variant="outlined"
                :hide-details="true"
          ...
          <v-row>
            ...
            >
              <v-textarea
                ...
                density="compact"
                :label="
                  t('components.konflikteLoesenForm.form.auskunftsSperre')
                "
                persistent-placeholder
                no-resize
                rows="2"
      ...
      <v-expansion-panel
        :title="
          t(
            'components.konflikteLoesenForm.expansionPanel.bewerberZusatzangaben'
          )
        "
      >
        <v-expansion-panel-text>
