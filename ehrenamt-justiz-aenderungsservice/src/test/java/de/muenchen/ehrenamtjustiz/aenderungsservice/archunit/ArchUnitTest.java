package de.muenchen.ehrenamtjustiz.aenderungsservice.archunit;

import com.tngtech.archunit.core.domain.JavaClasses;
import com.tngtech.archunit.core.importer.ClassFileImporter;
import com.tngtech.archunit.core.importer.ImportOption;
import com.tngtech.archunit.lang.ArchRule;
import de.muenchen.ehrenamtjustiz.aenderungsservice.AenderungsserviceApplication;
import de.muenchen.ehrenamtjustiz.aenderungsservice.archunit.rules.Rules;
...
public class ArchUnitTest {
    ...
    static void init() {
        allTestClasses = new ClassFileImporter()
                ...
                .importPackages(AenderungsserviceApplication.class.getPackage().getName());
    }
