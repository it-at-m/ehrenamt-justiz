...
## Running local in Podman

If the application is running local in Podman, it can be opened in the browser with the following link: http://localhost:8083/public/online/
