package de.muenchen.ehrenamtjustiz.backend.archunit;
...
import de.muenchen.ehrenamtjustiz.backend.archunit.rules.Rules;
...
public class ArchUnitTest {
    ...
    static void init() {
        allTestClasses = new ClassFileImporter()
                ...
                .importPackages(EhrenamtJustizApplication.class.getPackage().getName());
    }
